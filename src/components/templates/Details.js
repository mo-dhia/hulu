                    ...
                    <div className='details'>
                        ...
                        <div style={{ marginTop: "20vh" }}>
                            ...
                            <div className='dates-section'>
                                <span>{media.runtime || media.episode_run_time} min</span>
                                <span className='dates'>{media.release_date ? media.release_date.slice(0, 4) : media.first_air_date ?
                                    media.first_air_date.slice(0, 4) : null}</span>
